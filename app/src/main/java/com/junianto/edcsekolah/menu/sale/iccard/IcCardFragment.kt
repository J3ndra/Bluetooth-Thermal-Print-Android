package com.junianto.edcsekolah.menu.sale.iccard
...
import com.junianto.edcsekolah.a90.A90ICCardManager
...
class IcCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_ic_card, container, false)

        A90ICCardManager.openICCard()
    ...
    private val piccCheckRunnable = object : Runnable {
        override fun run() {
            val aret = IcApi.IccDetect_Api(0)
